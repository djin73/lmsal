...
pro correct_image, finalfilename, fitsfilename
a = finalfilename
fn= fitsfilename
ssw_path, /sot
loadct, 1
...
e = 'IRIS' + a + 'a_corrected'
	read_iris,fn,idata,xdata
	print,e
        wrt_fits,e,struct2fitshead(idata),fix(xdata) ;end
close,1
end ;proc

pro display_image, finalfilename, fitsfilename, scale1, scale2, colortable
a = finalfilename
c = scale1
d = scale2
j = colortable
